    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            ...
            if (data.toggle) {
                ...
                setTimeout(function(){
					setCharactersList()
                    $.post('https://mrf_charmenu/setupCharacters');
                    setTimeout(function(){
                        ...
                        $.post('https://mrf_charmenu/removeBlur');
                    }, 2000);
                }, 2000);
            } else {
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('https://mrf_charmenu/closeUI');
    $.post('https://mrf_charmenu/disconnectButton');
});
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('https://mrf_charmenu/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("char-selected");
...
$(document).on('click', '#create', function (e) {
    ...
    $.post('https://mrf_charmenu/createNewCharacter', JSON.stringify({
        firstname: firstname,
        lastname: lastname,
...
$(document).on('click', '#accept-delete', function(e){
    $.post('https://mrf_charmenu/removeCharacter', JSON.stringify({
...
function setCharactersList() {
    ...
    htmlResult += '</div>'
    htmlResult += '<div class="character-btn" id="play"></div><div class="character-btn" id="delete"></div>'
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('https://mrf_charmenu/selectCharacter', JSON.stringify({
